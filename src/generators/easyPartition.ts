...
import { IEasyCollectionAsync } from "../contracts";
import { Channel, isClosed } from "../csp/channel";

export function* easyPartition<T, R, N>(iterator: Iterator<T, R, N>, predicate: (value: T, index: number) => boolean): Generator<IEasyCollectionAsync<T, void, undefined>, R, undefined> {
 ...
 */
export function* easyPartitionAsync<T, R, N>(
    iterator: AsyncIterator<T, R, N>,
    predicate: (value: T, index: number) => boolean | Promise<boolean>
): Generator<IEasyCollectionAsync<T, void, undefined>, void, undefined> {
    const positive = new Channel<T>();
    const negative = new Channel<T>();
