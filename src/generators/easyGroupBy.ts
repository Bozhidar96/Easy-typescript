...
export function* easyGroupBy<T, R, N, TKey, TElement, TResult>(
 ...
 * @todo We should refactor this function to work even more easy!
 */
export async function* easyGroupByAsync<T, R, N, TKey, TElement, TResult>(
